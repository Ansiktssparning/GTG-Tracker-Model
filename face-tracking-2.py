...
face_classifier = tf.keras.models.load_model('models\GTG_tracker_test4') #load keras model
#face_classifier = tf.saved_model.load('models/GTG_tracker_test3') #load tensorflow model
